...
export default function EditCategoryPage() {
    ...
    const { id, name, setName, loading, handleSubmit } = useCategoryEdit();
            ...
            <div className="max-w-3xl mx-auto px-4 h-full flex flex-col justify-center">
                <div className="flex justify-between items-end mb-4">
                    <div>
                        <button
                            ...
                            className="text-xs px-2 py-1 -ml-2 text-purple-400 hover:text-category-300 mb-3 flex items-center gap-1 cursor-pointer"
                        >
                            ? Volver
                        </button>
                        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                            <SquarePen className="text-purple-400" size={24} />
                            Editar categoría
                        </h1>
                    </div>
                    <p className="text-slate-400 text-xs hidden md:block">
                        Modifique la informaci�n de la categoría.
                    </p>
                </div>
                ...
                >
                    ...
                    <div className="space-y-4">
                        <h3 className="text-purple-400 text-xs font-semibold border-b border-white/10 pb-1.5 uppercase">
                            Informaci�n b�sica
                        </h3>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-slate-700/90 border border-gray-500 rounded-lg px-3 py-2 text-xs text-white focus:ring-2 focus:ring-purple-400 outline-none transition-all placeholder:text-gray-400"
                                required
                            />
                        </div>
                    </div>
                ...
                <ConfirmModal
                    ...
                    message={
                        <>
                            �Seguro que quer�s guardar los cambios de{" "}
                            <b>{name}</b>?
                        </>
                    }
                    isLoading={loading}
