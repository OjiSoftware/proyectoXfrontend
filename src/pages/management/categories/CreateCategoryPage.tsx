...
import { useCreateCategory } from "@/hooks/useCategoryForm";
            ...
            <div className="max-w-3xl mx-auto px-4 h-full flex flex-col justify-center">
                <div className="flex justify-between items-end mb-4">
                    <div>
                        <button
                            ...
                            className="text-xs px-2 py-1 -ml-2 text-category-400 hover:text-category-300 mb-3 flex items-center gap-1 cursor-pointer"
                        >
                            ? Volver
                        </button>
                    ...
                    <p className="text-slate-400 text-xs hidden md:block">
                        Complete la informaci�n para crear una nueva categoría.
                    </p>
                </div>
                ...
                >
                    <div className="space-y-4">
                        <h3 className="text-category-400 text-xs font-semibold border-b border-white/10 pb-1.5 uppercase">
                            Informaci�n b�sica
                        </h3>
                ...
                <ConfirmModal
                    ...
                    message={
                        <>
                            �Seguro que quer�s crear la categoría{" "}
                            <b>{formData.name}</b>?
                        </>
                    }
                    isLoading={isLoading}
